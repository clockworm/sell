...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        BeanUtils.copyProperties(orderDTO,orderMaster,"orderId","orderAmount","orderStatus","payStatus");
    ...
    public OrderDTO cancel(OrderDTO orderDTO) {
        ...
        if (!OrderStatusEnum.NEW.getCode().equals(orderDTO.getOrderStatus())){
            log.error("取消訂單狀態不正確。orderId={},orderStatus={}",orderDTO.getOrderId(),orderDTO.getOrderStatus());
        ...
        if(CollectionUtils.isEmpty(orderDTO.getDetailList())){
            log.error("訂單中無商品詳情：orderDTO={}",orderDTO);
    ...
    public OrderDTO finish(OrderDTO orderDTO) {
        //判斷訂單的狀態
        if (!OrderStatusEnum.NEW.getCode().equals(orderDTO.getOrderStatus())){
            log.error("完結訂單狀態不正確。orderId={},orderStatus={}",orderDTO.getOrderId(),orderDTO.getOrderStatus());
            throw new SellException(ResultEnum.ORDERSTATUS_ERROR);
        }
        //修改狀態 完結狀態
        OrderMaster orderMaster = new OrderMaster();
